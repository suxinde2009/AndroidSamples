...
class XServerInfo : XSerializable {
    ...
    constructor(context: XServer) {
        mScreens.add(Platform.createScreen(context))
        mFormats.add(Format())
    }
    ...
    override fun toString(): String {
        ...
        builder.append("  resources;base=").append(intToHexString(mResourceIdBase))
                .append(",mask=").append(intToHexString(mResourceIdMask)).append('\n')
